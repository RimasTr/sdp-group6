...
nxjc balle/bluetooth/messages/*.java balle/controller/Controller.java balle/brick/BrickController.java balle/brick/Roboto.java balle/brick/pid/PIDConstants.java balle/brick/pid/GoStraight.java balle/brick/WallE.java \
&& nxjlink balle.brick.Roboto -o Roboto.nxj \
&& nxjlink balle.brick.WallE -o WallE.nxj \
