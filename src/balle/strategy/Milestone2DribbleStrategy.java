...
public class Milestone2DribbleStrategy extends AbstractPlanner {
	...
	private static Logger LOG = Logger
			.getLogger(Milestone2DribbleStrategy.class);
	...
	public Milestone2DribbleStrategy() {
		this(false);
	}

	public Milestone2DribbleStrategy(boolean triggerHappy) {
		super();
	...
	public static Milestone2DribbleStrategy factoryMethod() {
		return new Milestone2DribbleStrategy();
	}
