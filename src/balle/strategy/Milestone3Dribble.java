...
public class Milestone3Dribble extends AbstractPlanner {
	...
	public Milestone3Dribble() {
		this(false, false);
	}

	public Milestone3Dribble(boolean triggerHappy, boolean kicked) {
		super();
	...
	public void onStep(Controller controller, Snapshot snapshot) throws ConfusedException {
		...
		if ((facingGoal && snapshot.getBalle().getPosition()
				.dist(snapshot.getOpponentsGoal().getPosition()) <= 0.5)
